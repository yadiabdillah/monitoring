					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12 col-lg-6">
								...
								<h3>Data Rekapitulasi Berkas Keseluruhan</h3>
							<canvas id="barChart" style="height:230px;"></canvas>
							</div>
							<label for="form-field-select-1">Cari Berdasarkan Bulan</label>

							<form method="post" action="<?php echo base_url()?>index.php/Chart/chart_view">
									<div class="col-xs-6 col-lg-2">
															
															<select class="form-control" name="bulan" id="form-field-select-1">
								...
								<div class="col-xs-6 col-lg-2">
															...
															<select class="form-control" name="tahun" id="form-field-select-1">
														...
														<div class="col-xs-6 col-lg-2">
															<input class="btn btn-info" type="submit" value="Cari" name="submit">
														</div>
								</form>
								
							<div class="col-xs-12 col-lg-6">
								<h3>Data Rekapitulasi Berkas Bulan <?php echo $bulan; ?> <?php echo $tahun; ?> </h3>
...
<![endif]-->
		...
		<script src="<?php echo base_url()?>aceadmin/assets/js/Chart.js"></script>
		...
		<script type="text/javascript">
			 ...
			 var areaChartData = {
      labels  : ['Data Balik Nama Sertifikat', 'Pendirian PT/CV', 'Pendirian Yayasan'],
      datasets: [
        {
          ...
          data                : [<?php echo $balik_nama; ?>, <?php echo $form; ?>,<?php echo $yayasan; ?>]
        }
      ]
    }
      ...
      datasets: [
        {
          ...
          pointHighlightFill  : '#fff',
          pointHighlightStroke: 'rgba(60,141,188,1)',
          data                : [<?php echo $balik_nama_ini; ?>, <?php echo $form_bln_ini; ?>,<?php echo $yayasan_bln_ini; ?>]
        }
      ]
    }
