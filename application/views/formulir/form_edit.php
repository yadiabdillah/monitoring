                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Edit formulir Pendirian Badan Usaha PT / CV
                                </small>
                            </h1>
                        </div>
                        <!-- /.page-header -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    ...
                                    method="post"
                                    action="<?php echo base_url()?>index.php/Formulir/edit"
                                    role="form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        class="form-control"
                                        >
                                        <?php foreach($direktur as $key){?>
                                            <option <?php if ($key->id_pimpinan == $record['id_direktur']){echo "selected";} ?> value="<?php echo $key->id_pimpinan; ?>"><?php echo $key->nama_pimpinan; ?></option>
                                        <?php }  ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input
                                                ...
                                                name="userfile1"
                                                multiple="multiple"
                                                value="<?php echo $record['ktp_pendiri']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input
                                                ...
                                                name="userfile3"
                                                multiple="multiple"
                                                value="<?php echo $record['copy_pbb']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
