                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Lihat data Pendirian Badan Usaha / Yayasan
                                </small>
                            </h1>
                        </div>
                        <!-- /.page-header -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    ...
                                    method="post"
                                    action="<?php echo base_url()?>index.php/Formulir/view"
                                    role="form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                maxlength="30"
                                                readonly=""
                                                value="<?php echo $record['id_formulir']; ?>"
                                                placeholder=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input
                                                ...
                                                name="nama_direktur"
                                                readonly=""
                                                value="<?php echo $record['nama_pimpinan']; ?>"
                                                maxlength="30"
                                                class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                maxlength="30"
                                                readonly=""
                                                value="<?php echo $record['penanggung_jawab']; ?>"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                maxlength="30"
                                                readonly=""
                                                value="<?php echo $record['tempat_lahir']; ?>"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                <input
                                                    ...
                                                    name="tgl_lahir"
                                                    readonly=""
                                                    value="<?php echo $record['tgl_lahir']; ?>"
                                                    id="id-date-picker-1"
                                                    type="date"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea
                                                ...
                                                maxlength="100"><?php echo $record['alamat']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                name="pekerjaan"
                                                readonly=""
                                                value="<?php echo $record['pekerjaan']; ?>"
                                                maxlength="30"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['kewarganegaraan']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input
                                                ...
                                                value="<?php echo $record['nama_perusahaan']; ?>"
                                                maxlength="30"
                                                placeholder=""
                                                class="form-control"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea
                                                ...
                                                class="col-xs-10 col-sm-7"
                                                maxlength="100"><?php echo $record['alamat_perusahaan']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input
                                                ...
                                                readonly=""
                                                name="perusahaan"
                                                value="<?php echo $record['perusahaan']; ?>"
                                                maxlength="50"
                                                placeholder=""
                                                class="form-control"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['email_perusahaan']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="20"
                                                value="<?php echo $record['no_telp_perusahaan']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['modal_dasar']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="20"
                                                value="<?php echo $record['modal_ditempatkan']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea
                                                ...
                                                required=""
                                                name="bidang_usaha"
                                                class="col-xs-10 col-sm-7"><?php echo $record['bidang_usaha']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <textarea
                                                ...
                                                placeholder=""
                                                required=""
                                                name="komposisi_saham"
                                                class="col-xs-10 col-sm-7"><?php echo $record['komposisi_saham']; ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['direktur_perusahaan']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['wakil_direktur']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['komisaris1']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['komisaris2']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                            KTP Para Pendiri</label>

                                        <div class="col-sm-6">
                                            <img
                                                src="<?php echo base_url()?>images/formulir/<?php echo $record['ktp_pendiri']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <img
                                                src="<?php echo base_url()?>images/formulir/<?php echo $record['foto_npwp']; ?>"
                                                style="height: 400px; width: 600px;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <img
                                                src="<?php echo base_url()?>images/formulir/<?php echo $record['copy_pbb']; ?>"
                                                style="height: 400px; width: 600px;">
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                            Surat Keterangan RT / RW</label>

                                        <div class="col-sm-6">
                                            <img
                                                src="<?php echo base_url()?>images/formulir/<?php echo $record['sk_rtrw']; ?>"
                                                style="height: 400px; width: 600px;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="clearfix form-actions">
                                        <div class="col-md-offset-3 col-md-9">
											<a class="btn btn-lg btn-success" href="<?php echo base_url()."index.php/Formulir/view"; ?>"> <i class="ace-icon fa fa-check"></i></a>
