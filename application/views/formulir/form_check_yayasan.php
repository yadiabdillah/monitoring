                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    ...
                                    method="post"
                                    action="<?php echo base_url()?>index.php/Formulir/view_yayasan"
                                    role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input
                                                ...
                                                value="<?php echo $record['nama_yayasan']; ?>"
                                                maxlength="30"
                                                placeholder=""
                                                class="form-control"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea
                                                ...
                                                class="col-xs-10 col-sm-7"
                                                maxlength="100"><?php echo $record['alamat_yayasan']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['email_yayasan']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="20"
                                                value="<?php echo $record['no_telp_yayasan']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['kekayaan_awal']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['bidang_sosial']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input
                                                ...
                                                value="<?php echo $record['bidang_agama']; ?>"
                                                maxlength="70"
                                                placeholder=""
                                                class="form-control"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['bidang_pendidikan']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['wakil_ketua']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['bendahara']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['sekretaris']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                readonly=""
                                                maxlength="30"
                                                value="<?php echo $record['pengawas']; ?>"
                                                id="form-field-1"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
            ...
            <div class="footer-inner">
                <div class="footer-content">
                    <span class="bigger-120">
                        ...
                        Sistem Monitoring Berkas &copy; 2019
                    </span>
