...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8"/>
        <title>Notaris / PPAT Vika Fitriaini, ST, S.H, M.Kn</title>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    method="post"
                                    action="<?php echo base_url()?>index.php/chart/laporan_bulanan_pt"
                                    role="form">
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo "Rp. ".number_format($r->modal_dasar); ?>
                                            </td>
                                            <td>
    ...
    <script src="<?php echo base_url()?>aceadmin/assets/js/jquery-ui.min.js"></script>
    <script
                    ...
                    buttons: [
                        {
                            ...
                            "className": "btn btn-white btn-primary btn-bold",
                            autoPrint: false,
                            message: 'Data Laporan Berkas Pendirian Badan Usaha PT / CV'
                        }
                    ]
                });
            myTable
