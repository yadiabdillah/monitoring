...
<!--
					...
					<div class="page-content">
                        <div class="row">
                           <div class="col-xs-12">
                               <form method="post" action="<?php echo base_url()?>index.php/chart/laporan_bulanan_yayasan"  role="form">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                       ...
                                                       foreach ($record->result() as $r){
														...
														<td> <?php echo $r->id_formulir; ?> </td>
														<td> <?php echo $r->tgl_input; ?> </td>
														<td> <?php echo $r->nama_pimpinan; ?> </td>
														<td> <?php  echo $r->nama_yayasan; ?></td>
														<td> <?php echo $r->kekayaan_awal; ?>	</td> 
														<td> <?php echo $r->no_telp_yayasan; ?>	</td> 
				...
				new $.fn.dataTable.Buttons( myTable, {
					buttons: [
					  ...
					  },
					  {
						...
						"className": "btn btn-white btn-primary btn-bold",
						autoPrint: false,
						message: 'Laporan Bulanan Berkas Pendirian Badan Usaha Yayasan'
					  }		  
					]
				} );
