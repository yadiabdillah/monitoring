...
<!--
	 ...
	 <?php echo $this->session->flashdata('failed'); ?>
								...
								<?php } ?>
                                <a href="<?php echo base_url()?>index.php/Formulir/add_direktur" class="btn btn-success">
													  ...
													  <tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="<?php echo base_url()?>index.php/Formulir/check_direktur/<?php echo $r->id_pimpinan; ?>">
																	<i class="ace-icon fa fa-search-plus bigger-130"></i>
																</a>

																<a class="green" href="<?php echo base_url()?>index.php/Formulir/edit_direktur/<?php echo $r->id_pimpinan; ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="<?php echo base_url()?>index.php/Formulir/delete_direktur/<?php echo $r->id_pimpinan; ?>">
