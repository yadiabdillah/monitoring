                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-header">
                                    <h1>
                                        ...
                                        <small>
                                            ...
                                            Lihat data formulir Pendirian Badan Usaha PT / CV
                                        </small>
                                    </h1>
                                </div>
                                ...
                                <div class="table-header">
                                    Data formulir Pendirian Badan Usaha PT / CV
                                </div>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
															if ($r->status_berkas=='Submit') {
															 	# code...
															  ?>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a
                                                            class="blue"
                                                            href="<?php echo base_url()?>index.php/Formulir/check/<?php echo $r->id_formulir; ?>">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                        </a>

                                                        <a
                                                            class="green"
                                                            href="<?php echo base_url()?>index.php/Formulir/edit/<?php echo $r->id_formulir; ?>">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a
                                                            class="red"
                                                            href="<?php echo base_url()?>index.php/Formulir/delete/<?php echo $r->id_formulir; ?>">
                                                            <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                        </a>
                                                    </div>

                                                    <?php }else { ?>
                                                                              <a  href="<?php echo base_url().'index.php/Formulir/monitoring/'.$r->id_formulir; ?>" class="btn btn-primary">Lihat Histori Berkas</a>
