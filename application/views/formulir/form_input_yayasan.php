            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Tambah Data Pendirian Badan Usaha Yayasan
                                </small>
                            </h1>
                        </div>
                        <!-- /.page-header -->
                        ...
                        <div class="row">
                            <div class="col-xs-12"><?php $tggl= date('Y-m-d'); ?>
                                <!-- PAGE CONTENT BEGINS -->
                                <form
                                    class="form-horizontal"
                                    method="post"
                                    enctype="multipart/form-data"
                                    action="<?php echo base_url()?>index.php/Formulir/save_yayasan"
                                    role="form">
                                    <input
                                        type="hidden"
                                        name="id_user"
                                        value="<?php echo $this->session->userdata('id_user'); ?>">
                                    <input type="hidden" name="tgl_input" value="<?php echo $tggl; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="tipe_form" value="<?php echo $tipe_form; ?>">
                                        <div class="form-group">
                                        ...
                                        <?php foreach($direktur as $key){?>
                                            <option value="<?php echo $key->id_pimpinan; ?>"><?php echo $key->nama_pimpinan; ?></option>
                                        <?php }  ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <b>*format PDF dan dijadikan satu</b>
                                            </div>
                                        </div>
