                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-header">
                                    <h1>
                                        ...
                                        <small>
                                            ...
                                            Lihat data formulir Pendirian Badan Usaha Yayasan
                                        </small>
                                    </h1>
                                </div>
                                ...
                                <div class="table-header">
                                    Data formulir Pendirian Badan Usaha Yayasan
                                </div>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php  echo $r->nama_yayasan; ?></td>
                                                <td>
                                                    <?php echo $r->kekayaan_awal; ?>
                                                </td>
                                                <td>
                                                    <?php echo $r->no_telp_yayasan; ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a
                                                            class="blue"
                                                            href="<?php echo base_url()?>index.php/Formulir/check_yys/<?php echo $r->id_formulir; ?>">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                        </a>

                                                        <a
                                                            class="green"
                                                            href="<?php echo base_url()?>index.php/Formulir/edit_yayasan/<?php echo $r->id_formulir; ?>">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a
                                                            class="red"
                                                            href="<?php echo base_url()?>index.php/Formulir/delete_yys/<?php echo $r->id_formulir; ?>">
