                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Edit Data Pendirian Badan Usaha - Yayasan
                                </small>
                            </h1>
                        </div>
                        <!-- /.page-header -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    ...
                                    method="post"
                                    action="<?php echo base_url()?>index.php/Formulir/edit_yayasan"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php foreach($direktur as $key){?>
                                            <option <?php if ($key->id_pimpinan == $record['id_pimpinan']){echo "selected";} ?> value="<?php echo $key->id_pimpinan; ?>"><?php echo $key->nama_pimpinan; ?></option>
                                        <?php }  ?>
