                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    ...
                                    method="post"
                                    action="<?php echo base_url()?>index.php/Formulir/list_direktur"
                                    role="form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                maxlength="30"
                                                readonly=""
                                                value="<?php echo $record['id_pimpinan']; ?>"
                                                placeholder=""
                                 ...
                                 <!--   <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                maxlength="30"
                                                readonly=""
                                                value="<?php echo $record['penanggung_jwb']; ?>"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="clearfix form-actions">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="<?php echo base_url().'index.php/Formulir/list_direktur'; ?>" class="btn btn-lg btn-success"><i class="ace-icon fa fa-check"></i> <a/>
                                        </div>
                                    </div>
