...
<html lang="en">
    ...
    <body class="skin-3 no-skin">
                                ...
                                <div class="page-header">
                                    <h1>
                                        ...
                                        <small>
                                            ...
                                            Lihat data Balik Nama Sertifikat
                                        </small>
                                    </h1>
                                </div>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <i class="ace-icon fa fa-calendar bigger-110 hidden-480"></i>Tgl S. Ukur</th>
                                                <th>Harga</th>
                                                <th>No ID BDG. TNH</th>
                                                <th>Status Berkas</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="center">
                                                    <?php echo $no; ?></td>
                                                <td>
                                                    <?php  echo $r->id_sertifikat; ?></td>
                                                <?php if ($this->session->userdata("role")=="staff"){ ?>
                                                <td>
                                                    <?php  echo $r->nama; ?></td>
                                                <?php  } ?>
                                                <td>
                                                    <?php  echo $r->nama_penjual; ?></td>
                                                <td><?php echo $r->luas_tanah; ?></td>
                                                <td>
                                                    <?php echo $r->luas_bangunan; ?></td>
                                                <td>
                                                    <?php echo $r->tgl_surat_ukur; ?></td>
                                                <td>
                                                    <?php echo "Rp_".$r->harga_transaksi; ?>
                                                </td>
                                                <td>
                                                    <?php echo $r->no_id_bdg_tnh; ?></td>
                                                <td>
                                                    <?php echo $r->status_berkas; ?></td>
                                                <!--<td class="hidden-480"> <span class="label label-sm
                                                label-warning">Expiring</span></td>-->

                                                <td>
												<?php if ($r->status_berkas == 'Selesai'){
													echo "";
												}else { ?>
													  <div class="hidden-sm hidden-xs action-buttons">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-info dropdown-menu-right">
                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/sertifikat/ttd_akta/<?php echo $r->id_sertifikat; ?>">Tanda Tangan Akta</a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/sertifikat/valid_pajak/<?php echo $r->id_sertifikat; ?>">Validasi pajak</a>
                                                                </li>

                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/sertifikat/balik_nama/<?php echo $r->id_sertifikat; ?>">Proses balik Nama</a>
                                                                </li>

                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/sertifikat/selesai/<?php echo $r->id_sertifikat; ?>">Selesai</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <!--<a class=" btn btn-xs btn-purple " href="<?php echo
                                                        base_url()?>index.php/sertifikat/lolos/<?php echo $r->id_sertifikat; ?>"> Ubah
                                                        Status <i class="ace-icon fa fa-cogs bigger-130"></i> </a> -->
                                                        <!--<br><a class=" btn btn-xs btn-Inverse " href="<?php echo
                                                        base_url()?>index.php/sertifikat/lolos/<?php echo $r->id_sertifikat; ?>"> Assign
                                                        Messenger <i class="ace-icon fa fa-fighter-jet bigger-130"></i> </a> -->
                                                    </div>
                                                    ...
                                                    <div class="hidden-md hidden-lg">
                                                        <div class="inline pos-rel">
                                                            ...
                                                            <ul
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/Formulir/delete/<?php echo $r->id_sertikikat; ?>"
                                                                        class="tooltip-error"
                                                                        data-rel="tooltip"
                                                                        title="Delete">
                                                                        <span class="red">
        ...
        <!--<script src="<?php echo
        base_url()?>aceadmin/assets/js/dataTables.select.min.js"></script>-->
            ...
            jQuery(function ($) {
                ...
                // horizontal scrolling (sScrollX)
                    ...
                    "aoColumns": [
                        ...
                        null,
                        null,
                        <?php if ($this->session->userdata("role")=="staff"){ echo " null,"; } ?>
