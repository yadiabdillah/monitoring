                                ...
                                <div class="page-header">
                                    <h1>
                                        ...
                                        <small>
                                            ...
                                            Lihat data Pendirian Badan Usaha
                                        </small>
                                    </h1>
                                </div>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $r->id_formulir; ?>
                                                </td>
                                                <td>
                                                    <?php echo $r->nama; ?>
                                                </td>
                                                <td>
                                                    <?php echo $r->nama_pimpinan; ?>
                                                </td>
                                                <td>
                                                    <?php echo $r->penanggung_jawab; ?></td>
                                                <td>
                                                    <?php  echo $r->nama_perusahaan; ?></td>
                                                <td>
                                                    <?php  echo $r->bidang_usaha; ?></td>
                                                <td>
                                                    <?php echo $r->modal_dasar; ?>
                                                </td>
                                                <td>
                                                    <?php echo $r->no_telp_perusahaan; ?>
                                                </td>
                                                <td>
                                                    <?php echo $r->status_berkas; ?>
                                                </td>
													...
													echo "";
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-info dropdown-menu-right">
                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/formulir/ttd_akta/<?php echo $r->id_formulir; ?>">Tanda Tangan Akta</a>
                                                                </li>

                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/formulir/proses_domisili/<?php echo $r->id_formulir; ?>">Proses Domisili Usaha</a>
                                                                </li>

                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/formulir/proses_npwp/<?php echo $r->id_formulir; ?>">Proses Pembuatan NPWP</a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/formulir/proses_siup/<?php echo $r->id_formulir; ?>">Proses SIUP TDP</a>
                                                                </li>

                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/formulir/selesai/<?php echo $r->id_formulir; ?>">Selesai</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
