													...
													<?php $no=1;
													 foreach ($record->result() as $r){ ?>
													  <tr>
														...
														<td> <?php echo "Rp_".$r->harga_transaksi; ?> </td>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="<?php echo base_url()?>index.php/Sertifikat/check/<?php echo $r->id_sertifikat; ?>"> View
																	<i class="ace-icon fa fa-search-plus bigger-130"></i>
																</a>

																<a class=" btn btn-xs btn-primary " href="<?php echo base_url()?>index.php/sertifikat/lolos/<?php echo $r->id_sertifikat; ?>">
																	Verified <i class="ace-icon fa fa-credit-card bigger-130"></i>
																</a>
															</div>
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo base_url()?>index.php/Formulir/delete/<?php echo $r->id_sertikikat; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
