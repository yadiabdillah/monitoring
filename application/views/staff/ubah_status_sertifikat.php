					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<h1></h1>
                                                                <form class="form-horizontal" method="post" action="<?php echo base_url()?>index.php/invoice/save_sertifikat" role="form">
                                                                	<input type="hidden" name="id_user" value="<?php echo $record['id_user']; ?>">
                                                                	<input type="hidden" name="id_sertifikat" value="<?php echo $id_po; ?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> No Invoice</label>

										<div class="col-sm-3">
                                                                                    <input type="text" id="form-field-1-1" placeholder="" name="no_invoice" maxlength="50" class="form-control" />
										</div>
									</div>
                                                                        <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"  for="form-field-1"> Pengecekan Sertifikat </label>

										<div class="col-sm-6">
                                                                                    <input type="number" id="form-field-1" name="pengecekan_sertifikat" maxlength="30" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									       <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"  for="form-field-1"> Proses Balik Nama BPN </label>

										<div class="col-sm-6">
                                                                                    <input type="number" id="form-field-1" name="proses_balik_nama" maxlength="30" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									       <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"  for="form-field-1"> Jasa Notaris </label>

										<div class="col-sm-6">
                                                                                    <input type="number" id="form-field-1" name="jasa_notaris" maxlength="30" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
