                                                       ...
                                                       foreach ($record->result() as $r){
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="<?php echo base_url()?>index.php/Formulir/check/<?php echo $r->no_formulir; ?>">
																	<i class="ace-icon fa fa-search-plus bigger-130"></i>
																</a>

																	<a class=" btn btn-xs btn-primary " href="<?php echo base_url()?>index.php/formulir/lolos/<?php echo $r->no_formulir; ?>">
