...
<html lang="en">
	...
	<body class="skin-3 no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<?php 
		if ($this->session->userdata("jabatan")=="finance") {
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<h1></h1>
                                                                <form class="form-horizontal" method="post" action="<?php echo base_url()?>index.php/payment/save_payment_form" role="form">
										...
										<div class="col-sm-6">
                                                                                    <input type="number" id="form-field-1" name="jml_bayar" maxlength="30" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
