                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        <div class="row">
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Direktur</th>
                                                <th>
                                                    <i class="ace-icon fa fa-calendar bigger-110 hidden-480"></i>Tgl Invoice</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $r->no_invoice; ?>
                                                </td>
                                                <td>
                                                    <?php echo $r->perusahaan; ?></td>
                                                <td>
                                                    <?php echo $r->nama_pimpinan; ?></td>
                                                <td>
                                                    <?php  echo $r->tgl_invoice; ?></td>
                                                <td>
                                                    <?php echo "Rp_".number_format("$r->total_biaya"); ?>
                                                </td>
                                                <td>
                                                    <?php echo $r->status_bayar; ?></td>
                          ...
                          }else if ($r->status_bayar=='Bayar DP') {
                         ?>
                                                        <a
                                                            class=" btn btn-xs btn-primary "
                                                            href="<?php echo base_url()?>index.php/payment/lunas_balik_nama/<?php echo $r->id_invoice."
                                                            /".$r->total_biaya; ?>">
                                                            Bayar Lunas
                              ...
                              ?>
                                                        <a
                                                            ...
                                                            href="<?php echo base_url()?>index.php/payment/dp_balik_nama/<?php echo $r->id_invoice."
                                                            /".$r->total_biaya; ?>">
                                                            Bayar DP
                                                            <i class="ace-icon fa fa-credit-card bigger-130"></i>
                                                        </a>
                             ...
                             ?>
                                                        <a
                                                            class=" btn btn-xs btn-primary "
                                                            href="<?php echo base_url()?>index.php/payment/lihat_history_formulir/<?php echo $r->id_invoice; ?>">
                                                            Lihat History Pembayaran
                                                            <i class="ace-icon fa fa-credit-card bigger-130"></i>
                                                        </a>
														<a class="btn btn-xs btn-success" style="margin:3px" href="<?php echo base_url()?>index.php/payment/lihat_bukti_bayar_formulir/<?php echo $r->id_invoice; ?>">Lihat Bukti Bayar <i class="ace-icon fa fa-money bigger-130"></i></a>
                                            ...
                                            <?php 	} else{  ?>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a
                                                            class="blue"
                                                            href="<?php echo base_url()?>index.php/Sertifikat/check/<?php echo $r->id_sertifikat; ?>">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                        </a>

                                                        <a
                                                            class="green"
                                                            href="<?php echo base_url()?>index.php/Sertifikat/edit/<?php echo $r->id_sertifikat; ?>">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a
                                                            class="red"
                                                            href="<?php echo base_url()?>index.php/Sertifikat/delete/<?php echo $r->id_sertifikat; ?>">
                                                    ...
                                                    <div class="hidden-md hidden-lg">
                                                        <div class="inline pos-rel">
                                                            ...
                                                            <ul
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="<?php echo base_url()?>index.php/Formulir/delete/<?php echo $r->id_sertifikat; ?>"
                                                                        class="tooltip-error"
                                                                        data-rel="tooltip"
                                                                        title="Delete">
                                                                        <span class="red">
