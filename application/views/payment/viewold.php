					...
					<div class="page-content">
							...
							<h1>
								...
								<small>
									...
									Lihat Pembayaran Balik Nama Sertifikat
								</small>
							</h1>
						</div>
                                                  ...
                                                  <tr>
														...
														<?php if ($this->session->userdata("role")=="finance") { ?>
															...
															<div class="hidden-sm hidden-xs action-buttons">                              
																...
																<a class=" btn btn-xs btn-primary" href="<?php echo base_url()?>index.php/payment/lihat_history/<?php echo $r->id_invoice; ?>">
																History Bayar <i class="ace-icon fa fa-credit-card bigger-130"></i></a>
