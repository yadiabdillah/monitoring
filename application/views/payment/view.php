												...
												<tbody>
                                                 <?php 
                                                  ...
                                                  <tr>
														...
														<td> <?php echo "Rp_".$r->total_biaya; ?></td>
...
<?php if($r->status_bayar=='Bayar lunas')
{ 
echo 'Pembayaran Lunas';
 ...
 ?> 
<a class=" btn btn-xs btn-primary " href="<?php echo base_url()?>index.php/payment/lunas_sertifikat/<?php echo $r->id_invoice."/".$r->total_biaya; ?>">Bayar Lunas <i class="ace-icon fa fa-credit-card bigger-130"></i></a>
<?php }

 else { ?> 
<a class=" btn btn-xs btn-danger " href="<?php echo base_url()?>index.php/payment/dp_sertifikat/<?php echo $r->id_invoice."/".$r->total_biaya; ?>">Bayar DP <i class="ace-icon fa fa-credit-card bigger-130"></i> </a>
<a class=" btn btn-xs btn-primary " href="<?php echo base_url()?>index.php/payment/lunas_sertifikat/<?php echo $r->id_invoice."/".$r->total_biaya; ?>">Bayar Lunas <i class="ace-icon fa fa-credit-card bigger-130"></i></a>
<?php  }  ?>


<a class=" btn btn-xs btn-primary" href="<?php echo base_url()?>index.php/payment/lihat_history/<?php echo $r->id_invoice; ?>">History Bayar <i class="ace-icon fa fa-credit-card bigger-130"></i></a>
<a class="btn btn-xs btn-success" style="margin:3px" href="<?php echo base_url()?>index.php/payment/lihat_bukti_bayar/<?php echo $r->id_invoice; ?>">Lihat Bukti Bayar <i class="ace-icon fa fa-money bigger-130"></i></a>
</div>
</td>
<?php 	}  ?>
<!-- akhir aksi-->
