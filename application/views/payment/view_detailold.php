...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url()?>aceadmin/assets/dist/jquery.fancybox.css" type="text/css" media="screen" />
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						</div>			<button class="btn btn-lg btn-success">
                                                  ...
                                                  <tr>
													...
													<!--	<a id="single_image" href="<?php echo base_url(); ?>images/struk_dp/<?php echo $r->gambar; ?>"><img src="<?php echo base_url(); ?>images/struk_dp/<?php echo $r->gambar; ?>" style="width: 100px; height: 100px;"alt=""/></a>
														...
														<?php if ($this->session->userdata("role")=="finance") { ?>
															...
															<div class="hidden-sm hidden-xs action-buttons">  
																...
																if ($r->keterangan == 'Bayar DP') { 
																	...
																	<a class=" btn btn-xs btn-danger " href="<?php echo base_url()?>index.php/payment/dp_sertifikat/<?php echo $r->id_invoice."/".$r->total_biaya; ?>">
                                                     	 Bayar DP <i class="ace-icon fa fa-credit-card bigger-130"></i> </a>
															<?php	}
														} 
																if ($r->keterangan == 'Bayar Lunas') { ?>

																	<a class=" btn btn-xs btn-primary " href="<?php echo base_url()?>index.php/payment/lunas_sertifikat/<?php echo $r->id_invoice."/".$r->total_biaya; ?>">
														...
														<?php		
															...
															<!--	<a class=" btn btn-xs btn-primary " href="<?php echo base_url()?>index.php/payment/print_kwt_ser/<?php echo $r->id_payment; ?>">
																Cetak Kwitansi <i class="ace-icon fa fa-credit-card bigger-130"></i></a> -->
...
<![endif]-->
		...
		<script type="text/javascript" src="<?php echo base_url() ?>aceadmin/assets/dist/jquery.fancybox.js"></script>
	</body>
</html>
