                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <!--<li> <a href="#">Tables</a> </li> <li class="active">Simple &amp;
                            Dynamic</li>-->
                        </ul>
                        <!-- /.breadcrumb -->
                        <!-- <div class="nav-search" id="nav-search"> <form class="form-search"> <span
                        class="input-icon"> <input type="text" placeholder="Search ..."
                        class="nav-search-input" id="nav-search-input" autocomplete="off" /> <i
                        class="ace-icon fa fa-search nav-search-icon"></i> </span> </form> </div>
                        /.nav-search -->
                    </div>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="center">
                                <h1>Notaris Vika Fitriaini, ST, S.H, M.Kn</h1>
                            </div>
                            <?php 	if ($this->session->userdata("role")=="user") {
			 ?>
                            <div class="col-lg-6">
                            <div class="well well-lg ">
											<h4 >Anda Mempunyai</h4> <h2> <?php echo $serti; ?></h2>  <h4>Berkas Sertifikat Sedang Proses</h4>
										</div>
                       </div>
                                      
                            <div class="col-lg-6">
                            <div class="well well-lg ">
											<h4 >Anda Mempunyai <h4> <h2><? echo $form; ?></h2> <h4>Berkas Pendirian Badan Hukum Sedang Proses</h4>
										</div>
                       </div>
                                      
                            <div class="col-lg-6">
                            <div class="well well-lg ">
											<h4 class="blue">Anda Mempunyai </h4> <h2 class="blue"><?php  echo $serti_inv;?> </h2> <h4 class="blue">invoice Sertifikat yang belum dibayar</h4>
										</div>
                       </div>
                                      
                            <div class="col-lg-6">
                            <div class="well well-lg ">
											<h4 class="blue">Anda Mempunyai </h4><h2 class="blue"> <?php echo $form_inv;  ?></h2><h4 class="blue"> invoice Pendirian Badan Hukum yang belum dibayar</h4>
										</div>
                       </div>
                            <?php } ?>
                            ...
                            <?php if ($this->session->userdata('role') == 'user'){ ?>
                                ...
                                <tr>
                                <td>1</td>
                                <td>Cek Sertifikat</td>
                                <td>Rp. 350.000</td>
                                </tr>
                                <tr>
                                <td>2</td>
                                <td>Proses Balik Nama BPN Harga HT <= Rp.300.000.000</td>
                                <td>Rp. 3.000.000</td>
                                </tr>
                                <tr>
                                <td>3</td>
                                <td>Proses Balik Nama BPN Harga HT  Rp.301.000.000 s/d Rp 500.000.000</td>
                                <td>Rp. 5.000.000</td>
                                </tr>
                                <tr>
                                <td>4</td>
                                <td>Proses Balik Nama BPN Harga HT  > Rp 500.000.000</td>
                                <td>Rp. 8.000.000</td>
                                </tr>
                                <tr>
                                <td>5</td>
                                <td>Jasa Notaris Harga HT <= Rp.300.000.000 </td>
                                <td>Rp. 3.000.000</td>
                                </tr>
                                <tr>
                                <td>6</td>
                                ...
                                <tr>
                                <td>B</td>
                                <td colspan="2">Pendirian Badan Hukum</td>
                                </tr>
                                <tr>
                                <td>No</td>
                                <td>Jenis Layanan</td>
                          ...
                          <?php    } else { ?>
                                          <div class="col-sm-6">
                                <img src="<?php echo base_url()?>gambar/ikatan.jpeg"/>
                                <p>
                                    <u>
                                        <b>Visi Perusahaan</b>
                                    </u>
                                ...
                                <p>Kantor Notaris dan PPAT Vika Fitriaini, ST., SH., SH., M.Kn., melayani dengan
                                    cepat, efisien dan menjunjung tinggi etika dan integritas kepada masyarakat
                                    individu dan perusahan terutama di Kabupaten Bekasi untuk kebutuhan perlindungan
                                    hukum dalam transaksi bisnis dan pertanahan.

                                </div>

                                <div class="col-sm-6">
                                    <img src="<?php echo base_url()?>gambar/ppat.jpeg"/>
                                    <p>
                                        <u>
                                            <b>Misi Perusahaan</b>
                                        </u>

                                        <p>1. Meningkatkan kepercayaan klien kepada Kantor Notaris dan PPAT Vika
                                            Fitriaini, ST., SH., SH., M.Kn.
                                            <p>2. Menjalankan Standard Operating Procedure (SOP) yang efektif dalam
                                                memberikan pelayanan ke klien
                                                <p>3. Meningkatkan hubungan kepuasan antara staff dan Kantor Notaris dan PPAT
                                                    Vika Fitriaini, ST., SH., SH., M.Kn.. serta klien dalam setiap pelayanan memalui
                                                    service excellent dan kesepakatan kerja bersama.
                            ...
                            <script type="text/javascript">
                                jQuery(function ($) {
                                    ...
                                    // horizontal scrolling (sScrollX)
                                        ...
                                        // "http://127.0.0.1/table.php"	, , "sScrollY": "200px", "bPaginate": false,
                                        // "sScrollX": "100%", "sScrollXInner": "120%", "bScrollCollapse": true,
                                        // Note: if you are applying horizontal scrolling (sScrollX) on a
                                        // ".table-bordered" you may want to wrap the table inside a
                                        // "div.dataTables_borderWrap" element "iDisplayLength": 50
                                    ...
                                    new $
                                        ...
                                        .Buttons(myTable, {
                                            buttons: [
                                                {
                                                    "extend": "colvis",
                                                    "text": "<i class='fa fa-search bigger-110 blue'></i> <span class='hidden'>Show/hide co" +
                                                            "lumns</span>",
                                                    "className": "btn btn-white btn-primary btn-bold",
                                                    columns: ':not(:first):not(:last)'
                                                }, {
                                                    "extend": "copy",
                                                    "text": "<i class='fa fa-copy bigger-110 pink'></i> <span class='hidden'>Copy to clipbo" +
                                                            "ard</span>",
                                                    "className": "btn btn-white btn-primary btn-bold"
                                                }, {
                                                    "extend": "csv",
                                                    "text": "<i class='fa fa-database bigger-110 orange'></i> <span class='hidden'>Export t" +
                                                            "o CSV</span>",
                                                    "className": "btn btn-white btn-primary btn-bold"
                                                }, {
                                                    "extend": "excel",
                                                    "text": "<i class='fa fa-file-excel-o bigger-110 green'></i> <span class='hidden'>Expor" +
                                                            "t to Excel</span>",
                                                    "className": "btn btn-white btn-primary btn-bold"
                                                }, {
                                                    "extend": "pdf",
                                                    "text": "<i class='fa fa-file-pdf-o bigger-110 red'></i> <span class='hidden'>Export to" +
                                                            " PDF</span>",
                                                    "className": "btn btn-white btn-primary btn-bold"
                                                }, {
                                                    "extend": "print",
                                    ...
                                    var defaultColvisAction = myTable
                                        .button(0)
                                        .action();
                                    myTable
                                        .button(0)
                                    ...
                                    $(
                                        '#dynamic-table > thead > tr > th input[type=checkbox], #dynamic-table_wrapper ' +
                                        'input[type=checkbox]'
                                    )
                                        .eq(0)
                                        .on('click', function () {
