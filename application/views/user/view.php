													  ...
													  <tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo base_url()?>index.php/user/edit/<?php echo $r->id_user; ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="<?php echo base_url()?>index.php/user/delete/<?php echo $r->id_user; ?>">
