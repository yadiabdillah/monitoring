...
<!--
					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url()?>index.php/user/save" role="form">
                                                                	<input type="hidden" name="id_user" value="<?php echo $this->session->userdata('id_user'); ?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Username </label>

										<div class="col-sm-9">
                                                                                    <input type="text" id="form-field-1-1" placeholder="" required="" name="username" maxlength="50" class="col-xs-10 col-sm-5" />
										</div>
									</div>
                                                                        <div class="form-group">
										...
										<div class="col-sm-9">
                                                                                    <input type="text" id="form-field-1-1" placeholder="" required="" name="nama" maxlength="50" class="form-control" />
										</div>
									</div>
                                                                        <div class="form-group">
										...
										<div class="col-sm-9">
                                                                                    <input type="password" id="form-field-1" name="password" required="" maxlength="30" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
                                                                        <div class="form-group">
                                                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> E-mail </label>
                                                                                <div class="col-sm-9">
                                                                                    <input type="email" id="form-field-1" name="email" required="" maxlength="30" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                                                                    <input type="number" id="form-field-1" name="telp" required="" maxlength="30" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="space-4"></div>
										...
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Jabatan </label>
                                                                                <div class="col-sm-4">
                                                                                    <select class="form-control" name="jabatan" id="form-field-select-2" multiple="multiple">
