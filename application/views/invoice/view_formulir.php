                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                                                                                echo $r->nama_pimpinan;
                                                                                                                    ?>
                                                </td>
                                                <td>
                                                    <?php
                                                                                                                echo $r->penanggung_jawab;
                                                                                                                    ?>
                                                </td>
                                                <td>
                                                    <?php
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a
                                                            ...
                                                            href="<?php echo base_url()?>index.php/invoice/input_formulir/<?php echo $r->id_formulir; ?>">
                                                            Input Harga
                                                            <i class="ace-icon fa fa-credit-card bigger-130"></i>
                                                        </a>

                                                        <!--<a class=" btn btn-xs btn-warning " href="<?php echo
                                                        base_url()?>index.php/Sertifikat/check/<?php echo $r->id_sertifikat; ?>"> Bayar
                                                        DP </a> <a class=" btn btn-xs btn-danger " href="<?php echo
                                                        base_url()?>index.php/Sertifikat/check/<?php echo $r->id_sertifikat; ?>"> Lunas
                                                        </a> -->
                                                    </div>
                                                </td>
                                            </tr>
