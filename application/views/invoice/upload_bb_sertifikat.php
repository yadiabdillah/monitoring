                                            ...
                                            <div class="page-header">
                                                <h1>
                                                    ...
                                                    <small>
                                                        ...
                                                        Upload Bukt Bayar Balik Nama Sertifikat
                                                    </small>
                                                </h1>
                                            </div>
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<h1></h1>
                                                                <form class="form-horizontal" method="post" action="<?php echo base_url()?>index.php/invoice/bukti_bayardp_serti" role="form" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
                                                  <label class="col-sm-3 control-label no-padding-right"  for="form-field-1"> Bayar Dp </label>                                 
										</div>
									</div>
									       <div class="form-group">
