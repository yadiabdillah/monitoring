                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Tambah Invoice Pendirian Badan Usaha
                                </small>
                            </h1>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    ...
                                    method="post"
                                    action="<?php echo base_url()?>index.php/invoice/save_formulir"
                                    role="form">
                                    <input type="hidden" name="id_user" value="<?php echo $record['id_user']; ?>">
                                    <input type="hidden" name="no_formulir" value="<?php echo $id_po; ?>">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">
                                            Nama Pimpinan/Direktur </label>
