                                            ...
                                            <div class="page-header">
                                                <h1>
                                                    ...
                                                    <small>
                                                        ...
                                                        Upload Bukti Bayar Balik Nama Sertifikat
                                                    </small>
                                                </h1>
                                            </div>
	 ...
	 <?php echo $this->session->flashdata('success'); ?>
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<h1></h1>
                                                                <form class="form-horizontal" method="post" action="<?php echo base_url()?>index.php/invoice/bukti_bayar_serti" role="form" enctype="multipart/form-data">
                                                                	...
                                                                	<input type="hidden" name="total_biaya" value="<?php echo $record['total_biaya']; ?>">
                                                                	<input type="hidden" name="jenis_form" value="<?php echo $record['id_jenis']; ?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> No Invoice</label>

										<div class="col-sm-3">
                                                                                    <input type="text" id="form-field-1-1" placeholder="" name="no_invoice" maxlength="50" class="form-control" value="<?php echo $record['no_invoice']; ?>" readonly />
										</div>
									</div>
                                                                        <div class="form-group">
										...
										<div class="col-sm-6">
                                                  <label class="col-sm-3 control-label no-padding-right"  for="form-field-1"> Bayar Pelunasan </label>                                 
										</div>
									</div>
									       <div class="form-group">
										...
										<div class="col-sm-6">
                                                                                    <input type="file" id="form-field-1" name="userfile[]" maxlength="30" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
