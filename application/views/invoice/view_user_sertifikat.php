					...
					<div class="page-content">
							...
							<h1>
								...
								<small>
									...
									Lihat data Invoice Balik Nama Sertifikat
								</small>
							</h1>
						</div>
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
                                                        ...
                                                        <th>Luas Bangunan(m2)</th>
                                                         <th><i class="ace-icon fa fa-calendar bigger-110 hidden-480"></i>Tgl S. Ukur</th>
                                                         <th>Biaya Cek Sertifikat</th>
                                                        <th>Biaya Proses BPN</th>
                                                        <th>Harga Jasa Notaris</th>
												...
												<tbody>
                                                 <?php 
                                                  ...
                                                  <tr>
														...
														<td> <?php  echo $r->tgl_surat_ukur; ?></td>
														<td> <?php echo "Rp.".number_format($r->biaya_cek_sertifikat); ?></td>
														<td> <?php echo "Rp.".number_format($r->biaya_proses_bpn); ?></td>
														<td> <?php echo "Rp.".number_format($r->biaya_jasa_notaris); ?></td>
														<td> <?php echo "Rp.".number_format($r->total_biaya); ?></td>
															<td> <?php echo $r->status_bayar; ?></td>
															<td><?php if ($r->status_bayar == "Bayar lunas") {
																echo "";
												...
												<ul class="dropdown-menu dropdown-info dropdown-menu-right">
													<li>
														<a href="<?php echo base_url()?>index.php/invoice/bukti_bayardp_serti/<?php echo $r->id_invoice; ?>">Upload Bukti DP</a>
													</li>
													<li>
														<a href="<?php echo base_url()?>index.php/invoice/bukti_bayar_serti/<?php echo $r->id_invoice; ?>">Upload Bukti Lunas</a>
													</li>
										...
										<?php } ?>
														...
														<?php if ($this->session->userdata("role")=="finance") { ?>
															...
															<div class="hidden-sm hidden-xs action-buttons">
																<a class=" btn btn-xs btn-primary " href="<?php echo base_url()?>index.php/invoice/input_sertifikat/<?php echo $r->id_sertifikat; ?>">
																	Input Harga <i class="ace-icon fa fa-credit-card bigger-130"></i>
																</a>

																<!--<a class=" btn btn-xs btn-warning " href="<?php echo base_url()?>index.php/Sertifikat/check/<?php echo $r->id_sertifikat; ?>">
																	Bayar DP 
																</a>

																<a class=" btn btn-xs btn-danger " href="<?php echo base_url()?>index.php/Sertifikat/check/<?php echo $r->id_sertifikat; ?>">
																	Lunas 
																</a> -->
															</div>
														</td>
