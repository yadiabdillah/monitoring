                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    ...
                                    method="post"
                                    action="<?php echo base_url()?>index.php/Sertifikat/edit_penjual"
                                    role="form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                maxlength="30"
                                                readonly=""
                                                value="<?php echo $record['id_penjual']; ?>"
                                                placeholder=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                required=""
                                                name="nama_penjual"
                                                value="<?php echo $record['nama_penjual']; ?>"
                                                maxlength="50"
                                                class="form-control"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                type="text"
                                                id="form-field-1-1"
                                                name="nama_pasangan_penjual"
                                                required=""
                                                value="<?php echo $record['nama_pasangan']; ?>"
                                                maxlength="30"
                                                placeholder=""
                                                class="form-control"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                placeholder=""
                                                required=""
                                                name="tmp_lahir_pasangan"
                                                value="<?php echo $record['tempat_lahir_pasangan']; ?>"
                                                maxlength="30"
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                <input
                                                    ...
                                                    id="id-date-picker-1"
                                                    required=""
                                                    value="<?php echo $record['tgl_lahir_pasangan']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea
                                                ...
                                                value=""
                                                class="col-xs-10 col-sm-7"
                                                maxlength="100"><?php echo $record['alamat_pasangan']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                maxlength="30"
                                                value="<?php echo $record['pekerjaan_pasangan']; ?>"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                name="nik_pasangan"
                                                maxlength="25"
                                                value="<?php echo $record['nik_pasangan']; ?>"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                name="npwp_pasangan"
                                                maxlength="25"
                                                value="<?php echo $record['npwp_pasangan']; ?>"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <img
                                                src="<?php echo base_url()?>images/sertifikat/<?php echo $record['foto_ktp']; ?>"
                                            ...
                                            <input
                                                ...
                                                name="userfile1"
                                                multiple="multiple"
                                                value="<?php echo $record['foto_ktp']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                            Fotocopy Sertifikat</label>

                                        <div class="col-sm-9">
                                            <img
                                                src="<?php echo base_url()?>images/sertifikat/<?php echo $record['copy_sertifikat']; ?>"
                                                style="height: 400px; width: 600px;">
                                            <input
                                                type="file"
                                                id="id-input-file-2"
                                                name="userfile2"
                                                multiple="multiple"
                                                value="<?php echo $record['copy_sertifikat']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <img
                                                src="<?php echo base_url()?>images/sertifikat/<?php echo $record['foto_kk']; ?>"
                                                style="height: 400px; width: 600px;">
                                            <input
                                                type="file"
                                                id="id-input-file-2"
                                                name="userfile3"
                                                multiple="multiple"
                                                value="<?php echo $record['foto_kk']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                            Foto Buku Nikah</label>

                                        <div class="col-sm-9">
                                            <img
                                                src="<?php echo base_url()?>images/sertifikat/<?php echo $record['buku_nikah']; ?>"
                                                style="height: 400px; width: 600px;">
                                            <input
                                                type="file"
                                                id="id-input-file-2"
                                                name="userfile4"
                                                multiple="multiple"
                                                value="<?php echo $record['buku_nikah']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <img
                                                src="<?php echo base_url()?>images/sertifikat/<?php echo $record['foto_npwp']; ?>"
                                                style="height: 400px; width: 600px;">
                                            <input
                                                type="file"
                                                id="id-input-file-2"
                                                name="userfile5"
                                                multiple="multiple"
                                                value="<?php echo $record['foto_npwp']; ?>"/>
                                        </div>
                                    </div>
