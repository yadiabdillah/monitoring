                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo "Rp . ".number_format("$r->harga_transaksi"); ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        ...
                                                        <?php } else { ?>
                                                                    <a  href="<?php echo base_url().'index.php/Sertifikat/monitoring/'.$r->id_sertifikat; ?>" class="btn btn-primary">Lihat Histori Berkas</a>
                                                  <?php       } ?>
                                                    </div>
                                                </td>
                                            </tr>
