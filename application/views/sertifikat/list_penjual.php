...
<!--
	 ...
	 <?php echo $this->session->flashdata('failed'); ?>
								...
								<?php } ?>
                                <a href="<?php echo base_url()?>index.php/Sertifikat/add_penjual" class="btn btn-success">
											Tambah Penjual Sertifikat
										</a>
										<div class="clearfix">
													...
													<?php $no=1;
													 foreach ($record->result() as $r){ ?>
													  <tr>
														...
														<td> <?php echo $r->nama_pasangan; ?></td> 
														<!--<td class="hidden-480">	<span class="label label-sm label-warning">Expiring</span></td>-->

														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="<?php echo base_url()?>index.php/Sertifikat/check_penjual/<?php echo $r->id_penjual; ?>">
																	<i class="ace-icon fa fa-search-plus bigger-130"></i>
																</a>

																<a class="green" href="<?php echo base_url()?>index.php/Sertifikat/edit_penjual/<?php echo $r->id_penjual; ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="<?php echo base_url()?>index.php/Sertifikat/delete_penjual/<?php echo $r->id_penjual; ?>">
