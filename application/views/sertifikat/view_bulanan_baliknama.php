...
<!--
					...
					<div class="page-content">
                            <div class="row">
                               ...
                               <form method="post" action="<?php echo base_url()?>index.php/chart/laporan_bulanan_baliknama"  role="form">
                               	<label class="col-sm-2 control-label no-padding-right"  for="form-field-1"> Tanggal Awal</label>
									
                                   <div class="col-xs-2">
                                   				<div class="input-group input-group-sm">

													<input type="text" id="datepicker" name="tgl_awal" class="form-control" data-date-format="yy-mm-dd" />
                                   ...
                                   <div class="col-xs-2">
                                   				<div class="input-group input-group-sm">
													...
													<input type="text" id="datepicker2" name="tgl_akhir" class="form-control" data-date-format="yy-mm-dd"/>
													<span class="input-group-addon">
														<i class="ace-icon fa fa-calendar"></i>
													</span>
												</div>
										...
										<div class=" col-xs-2">
                                                                                    <input class="btn btn-sm btn-primary" type="submit" name="submit" value="Tampilkan">	
													...
													<?php $no=1;
													 foreach ($record->result() as $r){ ?>
													  <tr>
														...
														<td> <?php  echo $r->id_sertifikat; ?></td>
														...
														<td> <?php echo $r->no_id_bdg_tnh; ?></td> 
														<td> <?php echo $r->status_berkas; ?></td> 
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.DataTable( {
					...
					"aoColumns": [
					  { "bSortable": false },
					  null, null,null, null, null, null, null, <?php if ($this->session->userdata("role")=="staff"){ echo " null,"; } ?>
				...
				new $.fn.dataTable.Buttons( myTable, {
					buttons: [
					  ...
					  },
					  {
						...
						"className": "btn btn-white btn-primary btn-bold",
						autoPrint: false,
						message: 'Data Bulanan Berkas Balik Nama Sertifikat'
					  }		  
					]
				} );
