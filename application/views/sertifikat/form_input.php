                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Tambah data Balik Nama Sertifikat
                                </small>
                            </h1>
                        </div>
                        <!-- /.page-header -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    ...
                                    action="<?php echo base_url()?>index.php/Sertifikat/save"
                                    role="form">
                                    <input
                                        type="hidden"
                                        name="id_user"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php foreach($penjual as $key){?>
                                            <option value="<?php echo $key->id_penjual; ?>"><?php echo $key->nama_penjual; ?></option>
                                        <?php }  ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php foreach($pembeli as $key){?>
                                            <option value="<?php echo $key->id_pembeli; ?>"><?php echo $key->nama_pembeli; ?></option>
                                        <?php }  ?>
