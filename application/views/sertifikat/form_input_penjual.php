                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Tambah Penjual Sertifikat</li>
                        </ul>
                        <!-- /.breadcrumb -->
                    </div>
                    ...
                    <div class="page-content">
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Tambah Data Penjual Sertifikat
                                </small>
                            </h1>
                        </div>
                        <!-- /.page-header -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS --><?php $tggl = date('Y-m-d');?>
                                <form
                                    class="form-horizontal"
                                    method="post"
                                    enctype="multipart/form-data"
                                    action="<?php echo base_url() ?>index.php/Sertifikat/save_penjual"
                                    role="form">
                                    <input
                                        type="hidden"
                                        name="id_user"
