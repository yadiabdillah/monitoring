                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    ...
                                    method="post"
                                    action="<?php echo base_url()?>index.php/Sertifikat/edit_pembeli"
                                    role="form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                maxlength="30"
                                                readonly=""
                                                value="<?php echo $record['id_pembeli']; ?>"
                                                placeholder=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                required=""
                                                name="nama_pembeli"
                                                value="<?php echo $record['nama_pembeli']; ?>"
                                                maxlength="50"
                                                class="form-control"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea
                                                ...
                                                maxlength="100"><?php echo $record['alamat_pembeli']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input
                                                ...
                                                required=""
                                                id="form-field-1"
                                                value="<?php echo $record['tlp_pembeli']; ?>"
                                                placeholder=""
                                                class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input
                                                ...
                                                name="userfile1"
                                                multiple="multiple"
                                                value="<?php echo $record['ktp_pembeli']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input
                                                ...
                                                name="userfile2"
                                                multiple="multiple"
                                                value="<?php echo $record['foto_kk_pembeli']; ?>"/>
                                        </div>
                                    </div>
