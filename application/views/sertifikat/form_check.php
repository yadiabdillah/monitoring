                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    Detail Data Balik Nama Sertifikat
                                </small>
                            </h1>
                        </div>
                        <!-- /.page-header -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form
                                    ...
                                    method="post"
                                    action="<?php echo base_url()?>index.php/Sertifikat/view"
                                    role="form">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                            Foto KTP Pembeli</label>

                                        <div class="col-sm-9">
                                            <img
                                                src="<?php echo base_url()?>images/sertifikat/<?php echo $record['ktp_pembeli']; ?>"
                                                style="height: 400px; width: 600px;">
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                            Foto KK Pembeli</label>

                                        <div class="col-sm-9">
                                            <img
                                                src="<?php echo base_url()?>images/sertifikat/<?php echo $record['foto_kk_pembeli']; ?>"
                                                style="height: 400px; width: 600px;">
                                        </div>
                                    </div>
