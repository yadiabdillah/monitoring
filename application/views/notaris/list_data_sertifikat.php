													  ...
													  <tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class=" btn btn-xs btn-primary " href="<?php echo base_url()?>index.php/sertifikat/ttd_akta/<?php echo $r->id_sertifikat; ?>">
																	Tanda Tangan Akta <i class="ace-icon fa fa-credit-card bigger-130"></i>
																</a>
															</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.DataTable( {
					...
					"aoColumns": [
					  { "bSortable": false },
					  null, null,null, null, null, null, null, null, <?php if ($this->session->userdata("role")=="staff"){ echo " null,"; } ?>
